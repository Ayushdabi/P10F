...
/* harmony import */ var _staffmember_staffmember_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./staffmember/staffmember.component */ "./src/app/staffmember/staffmember.component.ts");
/* harmony import */ var _staffmember_staffmemberlist_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./staffmember/staffmemberlist.component */ "./src/app/staffmember/staffmemberlist.component.ts");
...
var routes = [
    ...
    {
        path: 'staffmember',
        component: _staffmember_staffmember_component__WEBPACK_IMPORTED_MODULE_33__["StaffmemberComponent"]
    },
    {
        path: 'staffmember/:id',
        component: _staffmember_staffmember_component__WEBPACK_IMPORTED_MODULE_33__["StaffmemberComponent"]
    },
    {
        ...
        component: _staffmember_staffmemberlist_component__WEBPACK_IMPORTED_MODULE_34__["StaffmemberlistComponent"]
    },
    {
        path: 'role',
...
/* harmony import */ var _staffmember_staffmember_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./staffmember/staffmember.component */ "./src/app/staffmember/staffmember.component.ts");
/* harmony import */ var _staffmember_staffmemberlist_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./staffmember/staffmemberlist.component */ "./src/app/staffmember/staffmemberlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _staffmember_staffmember_component__WEBPACK_IMPORTED_MODULE_45__["StaffmemberComponent"],
                _staffmember_staffmemberlist_component__WEBPACK_IMPORTED_MODULE_46__["StaffmemberlistComponent"]
            ],
            imports: [
...
var EndpointServiceService = /** @class */ (function () {
    function EndpointServiceService() {
        ...
        this.STAFF = this.SERVER_URL + "/Staff";
...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.get = function (endpoint, callback) {
        ...
        return this.httpClient.get(endpoint).subscribe(function (data) {
            ...
            console.log('<----------- callback get me success chal raha hai ---------->');
            callback(data);
        }, function (error) {
            console.log('ORS Error--', error);
            console.log('<----------- callback get me error chal raha hai ---------->');
        });
    };
    HttpServiceService.prototype.post = function (endpoint, bean, callback) {
        ...
        return this.httpClient.post(endpoint, bean).subscribe(function (data) {
            console.log(data);
            callback(data);
            console.log('<----------- callback post me success chal raha hai ---------->');
        }, function (error) {
            console.log('ORS Error--', error);
            console.log('<----------- callback post me error chal raha hai ---------->');
        });
    };
...
/***/ "./src/app/staffmember/staffmember.component.css":
/*!*******************************************************!*\
  !*** ./src/app/staffmember/staffmember.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = ".alertRedColor {\r\n    color: red;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/staffmember/staffmember.component.html":
/*!********************************************************!*\
  !*** ./src/app/staffmember/staffmember.component.html ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n</style>\r\n\r\n<div class=\"row\"\r\n  style=\"padding-top: 7%; padding-bottom:15%; background: url(assets/files/wall.jpg) no-repeat center center; background-attachment: fixed; background-size: cover; width:auto; height: auto;\">\r\n  <div class=\"col-sm-4\"></div>\r\n  <div class=\"col-sm-4\">\r\n    <div class=\"card\">\r\n      <div class=\"card-body shadow-lg grad\">\r\n        <form>\r\n\r\n          <h2 *ngIf=\"!form.data.id>0\" class=\"text-primary font-weight-bold text-center\">\r\n            {{ 'Add Staff Member' | translate }}\r\n          </h2>\r\n          <h2 *ngIf=\"form.data.id>0\" class=\"text-primary font-weight-bold text-center\">\r\n            {{ 'Update Satff Member' | translate }}\r\n          </h2>\r\n\r\n          <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{ form.message }}\r\n          </div>\r\n\r\n          <div *ngIf=\"form.error && form.message != null\" class=\"alert alert-danger alert-dismissible\">\r\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n            {{ form.message }}\r\n          </div>\r\n\r\n          <!-- Overview -->\r\n          <div style=\"padding-top:3%\">\r\n            <span class=\"pt-2\"><b>{{ 'FullName' | translate }}</b><span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i></div>\r\n                </div>\r\n                <input type=\"text\" name=\"fullName\" [(ngModel)]=\"form.data.fullName\" class=\"form-control\"\r\n                  placeholder=\"{{ 'Enter  fullName' | translate }}\">\r\n              </div>\r\n            </div>\r\n            <span class=\"alertRedColor\">{{ form.inputerror.fullName }}</span>\r\n          </div>\r\n          <!-- Purchase Date -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{ 'JoiningDate' | translate }}</b><span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-table grey-text\"></i></div>\r\n                </div>\r\n                <input type=\"date\" name=\"joiningDate\" [value]=\"form.data.joiningDate | date:'yyyy-MM-dd'\"\r\n                  (input)=\"form.data.joiningDate = parseDate($event.target.value)\" class=\"form-control form-control-sm\"\r\n                  required />\r\n              </div>\r\n            </div>\r\n            <span class=\"alertRedColor\">{{ form.inputerror.joiningDate }}</span>\r\n          </div>\r\n\r\n\r\n          <!-- Title -->\r\n          <div style=\"padding-top:3%\">\r\n            <span class=\"pt-2\"><b>{{ 'previousEmployer' | translate }}</b><span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i></div>\r\n                </div>\r\n                <input type=\"text\" name=\"previousEmployer\" [(ngModel)]=\"form.data.previousEmployer\" class=\"form-control\"\r\n                  placeholder=\"{{ 'Enter previousEmployer' | translate }}\">\r\n              </div>\r\n            </div>\r\n            <span class=\"alertRedColor\">{{ form.inputerror.previousEmployer }}</span>\r\n          </div>\r\n\r\n\r\n          <!-- Category -->\r\n          <div>\r\n            <span class=\"pt-2\"><b>{{ 'divison' | translate }}</b><span class=\"required-field\"></span></span>\r\n            <div class=\"col-sm-12\">\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-venus grey-text\"></i></div>\r\n                </div>\r\n                <select class=\"form-control\" name=\"divison\" id=\"divison\" [(ngModel)]=\"form.data.divison\"\r\n                  style=\"cursor: pointer;\">\r\n                  <option [ngValue]=\"\" value=\"undefined\">{{ 'Please divison' | translate }}</option>\r\n                  <option value=\"'It\">{{ 'It' | translate }}</option>\r\n                  <option value=\"sales\">{{ 'sales' | translate }}</option>\r\n                  <option value=\"Tax\">{{ 'Tax' | translate }}</option>\r\n                  <option value=\"Education\">{{ 'Education' | translate }}</option>\r\n                  <option value=\"Marketing\">{{ 'Marketing' | translate }}</option>\r\n                </select>\r\n              </div>\r\n              <span class=\"alertRedColor\">{{ form.inputerror.divison }}</span>\r\n            </div>\r\n          </div>\r\n\r\n          <!-- Buttons -->\r\n          <div class=\"row pt-3 pl-3 pb-3\">\r\n            <div class=\"pt-2\">\r\n              <button *ngIf=\"!form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                {{ 'Save' | translate }}\r\n              </button>\r\n            </div>\r\n            <div class=\"pt-2\">\r\n              <button *ngIf=\"form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                {{ 'Update' | translate }}\r\n              </button>\r\n            </div>\r\n            <div class=\"pl-3 pt-2\">\r\n              <button (click)=\"forward('/staffmemberlist')\" class=\"btn btn-md btn-warning\">\r\n                {{ 'List' | translate }}\r\n              </button>\r\n            </div>\r\n          </div>\r\n\r\n        </form>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/staffmember/staffmember.component.ts":
/*!******************************************************!*\
  !*** ./src/app/staffmember/staffmember.component.ts ***!
  \******************************************************/
...
var StaffmemberComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](StaffmemberComponent, _super);
    function StaffmemberComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.STAFF, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        return _this;
    }
    StaffmemberComponent.prototype.validate = function () {
        return this.validateForm(this.form.data);
    };
    StaffmemberComponent.prototype.validateForm = function (form) {
        var flag = true;
        var validator = this.serviceLocator.dataValidator;
    ...
    StaffmemberComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
    ...
    StaffmemberComponent.prototype.parseDate = function (dateString) {
        if (dateString) {
            return new Date(dateString);
        }
        return null;
    };
    StaffmemberComponent.prototype.test = function () {
    };
    StaffmemberComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-staffmember',
            template: __webpack_require__(/*! ./staffmember.component.html */ "./src/app/staffmember/staffmember.component.html"),
            styles: [__webpack_require__(/*! ./staffmember.component.css */ "./src/app/staffmember/staffmember.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])
...
/***/ "./src/app/staffmember/staffmemberlist.component.css":
/*!***********************************************************!*\
  !*** ./src/app/staffmember/staffmemberlist.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3N0YWZmbWVtYmVyL3N0YWZmbWVtYmVybGlzdC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/staffmember/staffmemberlist.component.html":
/*!************************************************************!*\
  !*** ./src/app/staffmember/staffmemberlist.component.html ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/staffmember/staffmemberlist.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/staffmember/staffmemberlist.component.ts ***!
  \**********************************************************/
/*! exports provided: StaffmemberlistComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StaffmemberlistComponent", function() { return StaffmemberlistComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _base_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../base-list.component */ "./src/app/base-list.component.ts");
/* harmony import */ var _service_locator_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service-locator.service */ "./src/app/service-locator.service.ts");
...
var StaffmemberlistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](StaffmemberlistComponent, _super);
    function StaffmemberlistComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.STAFF, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
    ...
    StaffmemberlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-staffmemberlist',
            template: __webpack_require__(/*! ./staffmemberlist.component.html */ "./src/app/staffmember/staffmemberlist.component.html"),
            styles: [__webpack_require__(/*! ./staffmemberlist.component.css */ "./src/app/staffmember/staffmemberlist.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])
    ], StaffmemberlistComponent);
    return StaffmemberlistComponent;
}(_base_list_component__WEBPACK_IMPORTED_MODULE_2__["BaseListCtl"]));
...
module.exports = __webpack_require__(/*! C:\Workspace\Project-10\Project10-WorkSpace\ORSProject10-UI\src\main.ts */"./src/main.ts");
